...
#define MAX_BUFFER 30001
char name[40];
enum {ID,BREAK,CHAR,DOUBLE,ELSE,FOR,IF,INT,FLOAT,CONTINUE,SWITCH,CASE,DO,ENUM,LONG,END,RETURN,STRUCT,VOID,WHILE,CT_INT,CT_REAL,CT_CHAR,CT_STRING,COMMA,
 SEMICOLON,LPAR,RPAR,LBRACKET,RBRACKET,LACC,RACC,ADD,SUB,MUL,DIV,DOT,AND,OR,NOT,ASSIGN,EQUAL,NOTEQ,
